...
module.exports = function (options = {}) {
    ...
    return {
        ...
        subscribe: function (group) {
            return new Subscriber(redis.createClient(options)).subscribe(channel.getPattern(group));
        },
        subscribeAsync: function (group) {
            return new Subscriber(redis.createClient(options)).subscribeAsync(channel.getPattern(group));
        }
    }
};
